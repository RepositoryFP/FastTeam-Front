...
class AccountInformationData {
   RxList<AccountInformationModel> accountInformation = RxList<AccountInformationModel>([]);

   void updateBranchItems(List<AccountInformationModel> items) {
    accountInformation.value = items;
  }
}
