...
import '../recommended_for_you_screen/widgets/recommended_for_item_widget.dart';
...
class RecommendedForYouScreen extends StatefulWidget {
  ...
  @override
  State<RecommendedForYouScreen> createState() => _RecommendedForYouScreenState();
}
      ...
      child:ColorfulSafeArea(
        ...
        child: Scaffold(
            ...
            appBar: CustomAppBar(
              ...
              centerTitle: true,
              title: AppbarTitle(text: "lbl_recommended".tr),
              actions: [
                AppbarImage(
                    onTap: (){
              ...
              child: Padding(
                  ...
                  child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        RecommendedCenterData model =recommendedList[index];
                        return RecommendedForItemWidget(model,
