...
class SertificateScreen extends StatefulWidget {
  const SertificateScreen({super.key});

  @override
  _SertificateScreenState createState() => _SertificateScreenState();
}

class _SertificateScreenState extends State<SertificateScreen> {
                ...
                child: Stack(
                  children: [
                    Positioned(
                      ...
                      right: 0,
                      child: Image.asset(
                        ImageConstant.imageLogoFPBesar,
                        fit: BoxFit.cover,
                      ),
                    ),
