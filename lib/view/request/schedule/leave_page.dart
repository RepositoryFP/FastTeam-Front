  ...
  Future<void> loadListLeaveOption() async {
    ...
    if (result['status'] == 200) {
      ...
      setState(() {
        ...
        dropdownOption = leaveOptionsList.map<String>((item) => item['name'].toString()).toList();
      });
    }
  }
  ...
  Widget _buildButton(BuildContext context) {
    ...
    insertLeaveSubmission() async {
      ...
      String? selectedCutiId =
          leaveOptionsList.firstWhere((element) =>
              element['name'] == leaveType)['id'];
      ...
      var result = await scheduleRequestController!.insertLeaveSubmission(requestBody, imageFile);
